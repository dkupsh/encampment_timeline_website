...
import { MapSubEvent as MapSubEventType, MapMarker, MapLabel } from '@/types/investigation';
import Image from 'next/image';
import { useEffect, useRef, useState } from 'react';

interface MapSubEventProps {
  subEvent: MapSubEventType;
}

export default function MapSubEvent({ subEvent }: MapSubEventProps) {
